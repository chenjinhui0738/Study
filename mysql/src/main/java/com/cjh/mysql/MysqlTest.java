...
public class MysqlTest {
     ...
     */
    public void Test5(){
        String sql = "select * from basic_pays where id in (SELECT DISTINCT NTH_VALUE(id, 2) OVER  ( PARTITION BY department ORDER BY salary DESC) second_highest_salary FROM basic_pays); ";
