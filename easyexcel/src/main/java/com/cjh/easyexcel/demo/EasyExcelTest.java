package com.cjh.easyexcel.demo;
...
public class EasyExcelTest {
    ...
    public void writeExcelOneSheetOnceWrite() throws IOException {
        ...
        // 生成EXCEL并指定输出路径
        OutputStream out = new FileOutputStream("F:\\temp\\withoutHead1.xlsx");
    ...
    public void writeExcelOneSheetMoreWrite() throws IOException {
        ...
        // 生成EXCEL并指定输出路径
        OutputStream out = new FileOutputStream("F:\\temp\\withoutHead2.xlsx");
        ExcelWriter writer = new ExcelWriter(out, ExcelTypeEnum.XLSX);
    ...
    public void writeExcelMoreSheetMoreWrite() throws IOException {
        ...
        // 生成EXCEL并指定输出路径
        OutputStream out = new FileOutputStream("F:\\temp\\withoutHead3.xlsx");
        ExcelWriter writer = new ExcelWriter(out, ExcelTypeEnum.XLSX);
